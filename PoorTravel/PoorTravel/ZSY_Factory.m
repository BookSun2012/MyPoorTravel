...
+(UIButton *)buttonWithFrame:(CGRect)frame
                   ...
                   layer:(CGFloat)layer
                    tag:(NSInteger)tag
                  supperView:(UIView *)supperView{
    return [self buttonWithFrame:frame Type:UIButtonTypeSystem Title:title fontSize:fontSize titleColor:[UIColor redColor] bgColor:[UIColor cyanColor] target:target selector:sel layer:(CGFloat)layer tag:(NSInteger)tag supperView:supperView];
